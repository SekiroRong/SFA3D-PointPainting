...
import sys
sys.path.append('../')
from utils.config import PP,pure,nothing,Ultimate
BN_MOMENTUM = 0.1
...
if __name__ == "__main__":
    ...
    m       = get_pose_net(num_layers=18,heads=heads, head_conv=64,
                                        imagenet_pretrained=True).to(device)
    summary(m, input_size=(5, 608, 608))