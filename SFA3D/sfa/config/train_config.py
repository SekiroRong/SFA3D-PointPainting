...
def parse_train_configs():
    ...
    parser.add_argument('--saved_fn', type=str, default='Ultimate_pp', metavar='FN',
                        help='The name using for saving logs, models,...')

    parser.add_argument('--root-dir', type=str, default='G:\PP\carla', metavar='PATH',
    ...
    parser.add_argument('--pretrained_path', type=str, default=r'G:\PP\carla\checkpoints\Ultimate_pp/Model_Ultimate_pp_epoch_82_0.484_0.777.pth', metavar='PATH',
    ...
    parser.add_argument('--lr', type=float, default=0.0002, metavar='LR', # 0.001
    ...
    configs.dataset_dir = configs.root_dir
