...
def compute_box_3d(dim, location, ry,inference=True):
    # dim: 3
    # location: 3
    # ry: 1
    # return: 8 x 3
...
def show_rgb_image_with_boxes(img, labels, calib,inference=True):
    for box_idx, label in enumerate(labels):
        ...
        if cls_id < 0:
            continue
        corners_3d = compute_box_3d(dim, location, ry,inference=inference)
        # print(calib.P2)
