...
def parse_args():
    ...
    parser.add_argument('--datapath', type=str, default='G:\PP\carla', help='root path of dataset')
    parser.add_argument('--pretrained', type=str,default=r'G:\PP\pth\weights_epoch_295_tl_0.93_vl_0.087.pth',help='load checkpoint')
    parser.add_argument('--resume', action='store_true', help='resume from pretrained path specified in prev arg')
    parser.add_argument('--savepath', type=str, default='G:\PP\pth', help='save checkpoint path')
...
def main():
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        if epoch % args.savefreq == 0:
            ...
            savepath = os.path.join(args.savepath, f'weights_epoch_{epoch}_tl_{train_loss}_vl_{val_loss}.pth')
