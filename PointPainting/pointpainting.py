...
class PointPainter():
    ...
    def paint(self, pointcloud, semantic, calib:KittiCalibration):
        ...
        # remove reflectivity
        pointcloud_full = copy.deepcopy(pointcloud)
        pointcloud = pointcloud[:,:3]
        # print(pointcloud)
        # pointcloud = pointcloud[:,[2,1,0]]
        # pointcloud[:,1] *= -1
        # pointcloud[:, 0] += 1
        # print('------')
        # print(pointcloud)
        ...
        # print(reflectivity)
        painted_pointcloud = np.hstack((pointcloud_full, semantic_channel)) # (N, 4)
        # painted_pointcloud = np.hstack((painted_pointcloud, reflectivity))
        # painted_pointcloud = painted_pointcloud[:,[2,1,0,3]]
        # painted_pointcloud[:,1] *= -1
